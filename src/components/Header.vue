...
defineEmits(['decrementarCantidad', 'incrementarCantidad', 'agregar-carrito', 'eliminar-producto', 'vaciar-carrito'])
                ...
                <nav class="col-md-6 a mt-5 d-flex align-items-start justify-content-end">
                    <div class="carrito">
                        ...
                        <div id="carrito" class="bg-white p-3">
                            <p v-if="carrito.length === 0" class=" m-0 text-center">El carrito esta vacio</p>
                            <div v-else>
